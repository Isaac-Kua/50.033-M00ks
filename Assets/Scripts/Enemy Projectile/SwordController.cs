...
public class SwordController : MonoBehaviour
{
    ...
    void Start()
    {
        transform.localScale = new Vector3(transform.localScale.x,transform.localScale.y * GameManager.Instance.currentLevel.knightSwordlength, transform.localScale.z);
